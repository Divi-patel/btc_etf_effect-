...
|---|---|---|---|
| **Aug 29, 2023**<br>_Grayscale court ruling_ | BTC ΔJV = -0.000266\*\*\* (p = 0.0000)<br>ETH ΔJV = -0.000656\*\*\* (p = 0.0000) | a12\* = -0.1647\* (p = 0.0519)<br>a21\* = -0.2440\*\* (p = 0.0163) | g12\* = +0.0445\* (p = 0.0840)<br>g21\* = +0.0418 (p = 0.1052) |
| **Oct 23, 2023**<br>_Paper baseline_ | **BTC ΔJV = -0.000247\*\*\* (p = 0.0000)<br>ETH ΔJV = -0.000617\*\*\* (p = 0.0000)** | **a12\* = -0.259\*\*\* (p < 0.001)<br>a21\* = -0.196\*\*\* (p < 0.001)** | **g12\* = +0.038\*\*\* (p < 0.001)<br>g21\* = +0.054\*\*\* (p < 0.001)** |
| **Jan 10, 2024**<br>_SEC official approval_ | BTC ΔJV = -0.000219\*\*\* (p = 0.0000)<br>ETH ΔJV = -0.000579\*\*\* (p = 0.0000) | a12\* = -0.0673 (p = 0.4151)<br>a21\* = -0.2127\*\* (p = 0.0110) | g12\* = +0.0282 (p = 0.2082)<br>g21\* = +0.0372\* (p = 0.0795) |
